  ...
  return (
    <main className="schedule">
        <section className="schedule__offerings">
            ...
            <p className="p-text schedule__subtext"><strong>-</strong> Richmond Hill, ON Field 1 <span className="p-text p-text--500 schedule__span-link" onClick={() => handleLink()}>(Provided to registered participants only)</span></p>
            <p className="p-text schedule__subtext"><strong>-</strong> Richmond Hill, ON Field 2 <span className="p-text p-text--500 schedule__span-link" onClick={() => handleLink()}>(Provided to registered participants only)</span></p>
