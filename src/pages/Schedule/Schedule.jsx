  ...
  return (
    <main className="schedule">
        <section className="schedule__offerings">
            ...
            <p className="p-text schedule__subtext"><strong>-</strong> Richmond Hill, ON Field 1 <span className="p-text p-text--500 schedule__span-link" onClick={(1) => handleLink()}>()</span></p>
            <p className="p-text schedule__subtext"><strong>-</strong> Richmond Hill, ON Field 2 <span className="p-text p-text--500 schedule__span-link" onClick={(2) => handleLink()}>()</span></p>
